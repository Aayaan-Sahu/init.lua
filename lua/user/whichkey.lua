...
local mappings = {
  ...
  ["F"] = { "<cmd>lua require'telescope.builtin'.live_grep(require('telescope.themes').get_dropdown({}))<cr>", "Find Text" },
...
-- Autocommand that reloads neovim whenever you save the whichkey.lua file
vim.cmd [[
    augroup whichkey_reload
        autocmd!
        autocmd BufWritePost whichkey.lua source <afile>
    augroup end
]]
